...
from .base import tensor_unary_op
...
def sigmoid(x: 'Tensor') -> 'Tensor':
    ...
    def backward(out_grad: np.ndarray) -> None:
        ...
        sigmoid_gradient(out_data.ravel(), out_grad.ravel(), x.grad.ravel(), n)
...
def relu(x: 'Tensor') -> 'Tensor':
    ...
    def backward(out_grad: np.ndarray) -> None:
        ...
        relu_gradient(out_data.ravel(), out_grad.ravel(), x.grad.ravel(), n)
...
def tanh(x: 'Tensor') -> 'Tensor':
    ...
    def backward(out_grad: np.ndarray) -> None:
        ...
        tanh_gradient(out_data.ravel(), out_grad.ravel(), x.grad.ravel(), n)
...
def softmax(x: 'Tensor', axis: int = -1) -> 'Tensor':
    ...
    def backward(out_grad: np.ndarray) -> None:
        ...
        softmax_gradient(out_data.ravel(), out_grad.ravel(), x.grad.ravel(), n, k)
...
def log_softmax(x: 'Tensor', axis: int = -1) -> 'Tensor':
    ...
    def backward(out_grad: np.ndarray) -> None:
        ...
        log_softmax_gradient(out_data.ravel(), out_grad.ravel(), x.grad.ravel(), n, k)
