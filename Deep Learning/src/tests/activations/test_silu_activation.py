...
from src.activations import SiLU


class TestSiLUActivation(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.activation_custom = SiLU()
        self.activation_tf = keras.layers.Activation("swish")
        
        
    def test_silu_activation_forward(self) -> None:
        """
        Test to verify that the forward pass of the custom silu activation
        """
    ...
    def test_silu_activation_backward(self) -> None:
        """
        Test to verify that the backward pass of the custom silu activation
        """
