...
class TestRMSNormalizationLayer(Test):
    ...
    def setUp(self) -> None:
        ...
        # Create the RMSNormalization layers
        self.layer_custom = RMSNorm()
        self.layer_torch = TorchRMSNorm(normalized_shape=self.x_torch.shape[1:])
    ...
    def test_rms_norm_forward(self) -> None:
        """
        Test to verify that the forward pass of the RMSNormalization layer in training mode is consistent with PyTorch.
        """
    ...
    def test_rms_norm_backward(self) -> None:
        """
        Test to verify that the backward pass of the RMSNormalization layer is consistent with PyTorch.
        """
