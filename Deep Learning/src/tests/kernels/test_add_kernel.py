    ...
    def test_add_performance(self):
        ...
        self.assertLess(
            ...
            msg=(
                ...
                f"torch.add: {t_torch_fwd:.6f}s, add_forward: {t_custom_fwd:.6f}s"
            )
        )
        ...
        self.assertLess(
            ...
            msg = (
                ...
                f"torch.add backward: {t_torch_bwd:.6f}s, add_backward: {t_custom_bwd:.6f}s"
            )
        )
