...
class TestSoftmaxActivation(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.activation_custom = Softmax()
        self.activation_tf = keras.layers.Activation("softmax")
        
        
    def test_softmax_activation_forward(self) -> None:
        """
        Test to verify that the forward pass of the custom Softmax activation
        """
    ...
    def test_softmax_activation_backward(self) -> None:
        """
        Test to verify that the backward pass of the custom Softmax activation
        """
